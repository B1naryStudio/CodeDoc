					...
					<div>
						<div className="row">
							...
							<div className="col-md-3 col-sm-6 col-xs-6">
								<a ref='#/md-file-mode' data-toggle="tooltip" title="Create new markdown file" onClick={ this.newFile.bind(this) } className="btn btn-default btn-lg">
							...
							<div className="col-md-3 col-sm-6 col-xs-6">
								<a ref='#/md-file-mode' data-toggle="tooltip" title="Open markdown file" onClick={ this.openFile.bind(this) } className="btn btn-default btn-lg">
							...
							<div className="col-md-3 col-sm-6 col-xs-6">
								<a onClick={ this.openDocumenting.bind(this) } className="btn btn-default btn-lg">
							...
							<div className="col-md-3 col-sm-6 col-xs-6">
								<a onClick={ this.openLineCommenting.bind(this) } className="btn btn-default btn-lg">
							...
							<div className="col-md-6 col-sm-6 col-xs-12">
								...
								<div className="panel-body">
									<div className="list-group recent-files">
										...
										<a href="#" className="list-group-item">Google</a>
